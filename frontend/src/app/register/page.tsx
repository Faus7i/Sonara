    ...
    <div className="min-h-screen flex items-center justify-center bg-spotify-black">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-spotify-subtext mt-2">创建新账号</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-spotify-subtext mb-1">昵称</label>
            <input
              type="text"
              value={nickname}
        ...
        <p className="text-center text-sm text-spotify-subtext mt-6">
          已有账号？{' '}
          <Link href="/login" className="text-spotify-green hover:underline">
            登录
          </Link>
        </p>
      </motion.div>
